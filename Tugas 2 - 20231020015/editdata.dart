...
import 'package:latihancrud/main.dart';
...
class _EditState extends State<Edit> {
  ...
  void editData(){
    var url = Uri.parse('http://192.168.100.4/restapi/update.php'); //update api calling
    http.post(url, body: {'id':widget.list[widget.index]['id'],'title': title.text,'content':content.text});
  }
